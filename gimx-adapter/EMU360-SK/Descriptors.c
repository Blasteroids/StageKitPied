...
const USB_Descriptor_Device_t PROGMEM DeviceDescriptor = {
        ...
        .VendorID = 0x0e6f,  // 0x045e - MS   0x0e6F - PDP  
        .ProductID = 0x0103,  // 0x028e - 360 controller   0x0103 - Stage Kit
        .ReleaseNumber = 0x0101,  // 0x0110 - 360 controller.  0x0101 - Stage Kit
...
const struct
 {
    ...
    uint8_t UnkownDescriptor4[0x06];
        ...
        .UnkownDescriptor1 = {
                0x11, 0x21, 0x10, 0x01, 0x09, 0x25, 0x81, 0x14,
...
const USB_Descriptor_String_t PROGMEM ManufacturerString = {
        .Header = { .Size = USB_STRING_LEN(29), .Type = DTYPE_String },  // 14 for MS
        .UnicodeString = L"Performance Designed Products" //L"Microsoft Inc."
};

const USB_Descriptor_String_t PROGMEM ProductString = {
        .Header = { .Size = USB_STRING_LEN(18), .Type = DTYPE_String }, // 10 for Controller
        .UnicodeString = L"PDP Home Stage Kit" // L"Controller"
};

const USB_Descriptor_String_t PROGMEM SerialString = {
        .Header = { .Size = USB_STRING_LEN(8), .Type = DTYPE_String },
        .UnicodeString = L"003BF01D"  // L"1008366"
};
